...
namespace SVMTrainClass
{
    ...
    class svm_train
    {
        ...
        private int nr_fold;
        public string modelWritingDirectory;
        ...
        private void run(System.String[] argv)
        {
           ...
           // MessageBox.Show("hello");
            ...
            {
                MessageBox.Show("Error: " + error_msg + "\n");
              //  Console.ReadLine();
                System.Environment.Exit(1);
            }
            ...
            else
            {
                ...
                modelWritingDirectory += model_file_name;
                //MessageBox.Show(model_file_name);
                svm.svm_save_model(modelWritingDirectory, model);
            }
        }

        //	[STAThread]
        public void runSVM(System.String[] argv, string directory)
        {


            //svm_train t = new svm_train();
            modelWritingDirectory = directory;

            run(argv);
          //  Console.ReadLine();
        }

        private double atof(System.String s)
        {
            return System.Double.Parse(s);
        }

        private int atoi(System.String s)
        {
    ...
    public class svm_predict
    {
        ...
        private void predict(System.IO.StreamReader input, System.IO.BinaryWriter output, svm_model model, int predict_probability)
        {
            int correct = 0;
            int total = 0;
            double error = 0;
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    //the above operation of output to file may not be clear
                    //here we output to console for better readability (added by Andrew Polar)
       ...
       // [STAThread]
        public int run_svm(System.String[] argv,int statusLoad)
        {
            ...
            try
            {
                ...
                if (statusLoad != 1781)
                {
                    model = svm.svm_load_model(argv[i + 1]); // Model file
                }
